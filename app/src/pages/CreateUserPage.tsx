...
export function CreateUserPage() {
    ...
    useEffect(() => {
        async function tryRestore() {
            ...
            if (authData != null) {
                ...
                navigate("/", {
                    state: { banner: `Welcome back ${authData.userName}!. Enter ${challenge.name} now.` }
                });
            }
        }
    ...
    async function handleSave() {
        ...
        try {
            ...
            let local = getChallenge(challenge.id);
        ...
        <main className="flex flex-col min-h-screen bg-base-200">
            <div className="navbar bg-base-200 shadow px-4">
                <div className="flex-none">
                    <Link to="/" className="btn btn-ghost btn-sm normal-case text-base-content/80">
                        ← Back
                    </Link>
                </div>
            </div>
                ...
                <div className="card w-full bg-base-200">
                    <div className="card-body">
                        ...
                        <div className="flex justify-center mt-6">
                            ...
                            >
                                {isGoogleUser? "Your Google account is linked " : "Continue with Google"}
                            </button>
                        </div>
